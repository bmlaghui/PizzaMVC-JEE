...
<html>
   ...
   <body>
      ...
      <br>
      <%
         final Pizza pizza = (Pizza) request.getAttribute("existingpizza");
         %>
      <div class="container col-md-6">
         <div class="card">
            <div class="card-body">
               ...
               <form method="post"
                  action="${pageContext.request.contextPath}/ControllerPizza?action=update">
                  ...
                  <fieldset class="form-group">
                     <label>Description</label> <input type="text" value="<%if (pizza != null) out.print(pizza.getDescription());%>"
                        class="form-control" name="description" />
                  </fieldset>
                  <fieldset class="form-group">
                     <label>Image</label> <input type="file"  value="<%if (pizza != null)  out.print(pizza.getImage());%>"  id="imageSelected" class="form-control" accept=".jpg, .jpeg, .png" />
                  </fieldset>
                  <fieldset class="form-group">
                        ...
                        <div class="col-md-9">
                           <div class="form-check">
                              <%
                                 ...
                                 %>
                              <input class="form-check-input" type="checkbox"  name="ingredients"  value="<%out.print(unIngredient.getNumIngredient());%>"
                                 <%for (Ingredient oneIngredient : pizza.getIngredients()) {
                                    if (unIngredient.getNumIngredient() == oneIngredient.getNumIngredient()) {
                                    	out.print("checked");
                                    }

                                    }%> /> <label>&nbsp; &nbsp; <% out.print(unIngredient.getNomIngredient());%></label>&nbsp; &nbsp; &nbsp;
                              <%
                                 }
                                 %>
                           </div>
         ...
         <footer class="page-footer font-small dark">
            <!-- Copyright -->
            <div class="footer-copyright text-center py-3"> © 2020 Copyright <a href="https://wWW.mlaghuibrahim.com/">Brahim MLAGHUI</a>
            </div>
            <!-- Copyright --> 
         </footer>
         <script src="assets/js/app-ajax.js"></script>
